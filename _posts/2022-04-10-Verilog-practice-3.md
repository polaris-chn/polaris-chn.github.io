...
## 5. 补充
对于阻塞和非阻塞的一些补充，来看一个具体的实例。如下图所示，对于同在时序电路中的程序，采用阻塞和非阻塞两种方式得到的电路结构是不同的。对于非阻塞方式，得到的是触发器链，这样c的输出肯定就会比b慢一拍；而对于阻塞方式，得到是一个触发器，那么输出b和c是完全一样的，其时序也完全一致。

![](/images/blog/picture15.jpg)

![](/images/blog/picture16.jpg)

![](/images/blog/picture17.jpg)

![](/images/blog/picture18.jpg)

如果这里不是在时序电路中，而是在组合电路中，如果输出必须要保存值，组合电路中具有记忆功能的只能是latch了。
